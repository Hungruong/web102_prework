...
function addGamesToPage(games) {
 ...
 games.forEach(game => {
   ...
   gameInfo.innerHTML = `<p>${game.name}</p>`;
   gameInfo.innerHTML += `<p>${game.description}</p>`;
   gameDiv.appendChild(gameInfo);

   const gameStats = document.createElement('div');
   gameStats.classList.add('game-stats');
   gameStats.innerHTML += `<p>Pledged: $${game.pledged}</p>`;
   gameStats.innerHTML += `<p>Goal: $${game.goal}</p>`;
   gameStats.innerHTML += `<p>Backers: ${game.backers}</p>`;
   gameDiv.appendChild(gameStats);
   gameStats.appendChild(gameImg);
